...
export default function EditPointsCoursePage() {
    ...
    const fetchCourse = async () => {
      try {
        ...
        if (course) {
          ...
          setInputMode(course.course_type === "from_courses" ? "select" : "custom");
        }
      } catch (error) {
        console.error("Error fetching course:", error);
        Swal.fire({ icon: "error", title: "ไม่พบข้อมูลคอร์ส" });
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500">แก้ไขข้อมูลคอร์สในหน้า Points</p>
      </div>
