'use client'
import { GraduationCap, User, Home, BarChart3, Target, Users, ChevronDown, Coins, Sparkles, Settings, LogOut, FileText, Calculator } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { href: "/mock-exam", label: t("mockExam"), icon: FileText },
  ];
