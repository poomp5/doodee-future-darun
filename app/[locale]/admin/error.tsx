...
const translations = {
  th: {
    title: "เกิดข้อผิดพลาดในแอดมิน",
    message: "เกิดข้อผิดพลาดขณะดำเนินการในแผงควบคุมแอดมิน",
    tryAgain: "ลองอีกครั้ง",
    backToDashboard: "กลับสู่แดชบอร์ด",
    needHelp: "หากปัญหายังคงอยู่ กรุณาติดต่อทีมพัฒนา",
  },
  en: {
    title: "Admin Error",
    message: "An error occurred while performing an admin operation.",
    tryAgain: "Try Again",
    backToDashboard: "Back to Dashboard",
    needHelp: "If the problem persists, please contact the development team",
  },
};
