...
interface CourseForm {
  ...
  subcategories: string[];  // Changed to array for multiple subcategories
  duration: string;
  instructor: string;
  source: string;
  link_url: string;
...
export default function NewCoursePage() {
  ...
  return (
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-800">เพิ่มคอร์สใหม่</h1>
        <p className="text-gray-500">กรอกข้อมูลคอร์สเพื่อเพิ่มลงในระบบ</p>
      </div>
